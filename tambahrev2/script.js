...
$(".next-step").click(function () {
    ...
    var rp = "Rp" + value2;
    $('#rp').html(rp);
    var list = '<div class="checkbox-round">' + '<input type="checkbox" id="checkbox' + counter + '"/>' 
    + '<label for="checkbox' + counter + '">' + "</label>" + "</div>" + "<ul>" + '<li class="subjudul">' + value3 + "</li>" + '<li class="d-flex align-items-center isi">' + value4
    + '<i class="fa fa-circle" aria-hidden="true">' + "</i>" + rpp + value5 + "</li>" + '<li class="isi2">' + value6 + "</li>" + "</ul>";
    $('#list').html(list);                      
});
